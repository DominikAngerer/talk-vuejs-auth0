  ...
  <div class="dashboard">
    ...
    <div class="container">
      <div class="card-columns">
        ...
        <a class="card" :href="getStoryLink(story)" target="_blank" v-for="story in stories" v-bind:key="story.id">
...
export default {
  ...
  mounted() {
    axios
      .get(
        "https://api.storyblok.com/v1/cdn/stories?starts_with=tp&excluding_fields=body&excluding_ids=48471,48547,60491,127375,101145&token=dtONJHwmxhdJOwKxyjlqAgtt"
      )
      .then(res => {
